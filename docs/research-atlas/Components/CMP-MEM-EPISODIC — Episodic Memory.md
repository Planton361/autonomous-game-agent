---
atlas_id: CMP-MEM-EPISODIC
atlas_type: Component
atlas_name: Episodic Memory
atlas_level: L3
...
# CMP-MEM-EPISODIC — Episodic Memory

Generated from Registry YAML; fully overwriteable. Do not edit structured claims here.

Observation/action/skill-result persistence and append-only events provide trajectory material. No dedicated consolidated episode entity or complete episodic retrieval lifecycle is established.
