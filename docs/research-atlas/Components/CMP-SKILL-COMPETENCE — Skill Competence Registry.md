---
atlas_id: CMP-SKILL-COMPETENCE
atlas_type: Component
atlas_name: Skill Competence Registry
atlas_level: L3
...
# CMP-SKILL-COMPETENCE — Skill Competence Registry

Generated from Registry YAML; fully overwriteable. Do not edit structured claims here.

SkillRegistry aggregates persisted skill result history. Versioned controllers, certification metrics and activation state are not supplied by this history API.
