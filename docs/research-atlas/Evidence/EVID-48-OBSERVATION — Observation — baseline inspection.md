---
atlas_id: EVID-48-OBSERVATION
atlas_type: Evidence
atlas_name: Observation — baseline inspection
atlas_level: null
...
path: src/fh_agent/observation/schemas.py
symbol: Observation
line: 46
supports:
...
# EVID-48-OBSERVATION — Observation — baseline inspection

Generated from Registry YAML; fully overwriteable. Do not edit structured claims here.

Observation stores visible frame/UI/text/spatial evidence and last_action_result. It is a payload, not a temporal stabilizer or independent outcome evaluator. Baseline source inspection found no separate central TemporalState or first-class VisibleOutcome artifact; those target nodes remain unverified.

## Evidence locator

Provenance: github_implementation. Checked: 2026-09-09.

[Source](https://github.com/Planton361/autonomous-game-agent/blob/7b4ec2e1497dec50c94b921b61dab42245bf5c90/src/fh_agent/observation/schemas.py#L46) · Observation
